...
sample_size = 8
param_values_ABA_features = saltelli.sample(problem_ABA_features, sample_size, calc_second_order=True)
...
for x in range(300):
    ...
    print("SA analysis")
    Si = sobol.analyze(problem_ABA_features,pred_y_array, print_to_console=False)
...
resultdf.to_csv("265Features_sobol.csv")
